# Generated by Powerlevel10k configuration wizard on 2025-07-22 at 13:30 IST.
...
() {
  ...
  # The shell intentionally prints a startup greeting before the prompt, and
  # kubectl completion may emit a non-fatal background-job diagnostic. Keep
  # instant prompt enabled without treating that console output as a warning.
